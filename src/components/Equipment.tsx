...
const equipments: Equipment[] = [
  {
    ...
    description: 'Équipement de dernière génération pour des examens échographiques précis',
    image: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    features: ['Imagerie haute résolution', 'Doppler couleur', 'Sondes multiples', 'Archivage numérique'],
    category: 'diagnostic'
  },
  {
    id: '2',
    name: 'Électrocardiographe Digital',
    description: 'ECG 12 dérivations pour une surveillance cardiaque complète et fiable',
    image: 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    features: ['12 dérivations', 'Analyse automatique', 'Écran tactile', 'Impression immédiate'],
    category: 'diagnostic'
  },
  {
    id: '3',
    name: 'Tensiomètre Professionnel',
    description: 'Mesure précise de la tension artérielle avec validation clinique',
    image: 'https://images.unsplash.com/photo-1576671081837-49000212a370?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    features: ['Mesures certifiées', 'Détection arythmie', 'Historique patient', 'Bluetooth intégré'],
    category: 'monitoring'
  },
  {
    id: '4',
    name: 'Stérilisateur Médical',
    description: 'Autoclave professionnel garantissant une stérilisation optimale',
    image: 'https://images.unsplash.com/photo-1582750433449-648ed127bb54?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    features: ['Stérilisation vapeur', 'Cycles programmés', 'Traçabilité complète', 'Normes EN 13060'],
    category: 'hygiene'
  },
  {
    id: '5',
    ...
    image: 'https://images.unsplash.com/photo-1631815588090-d4bfec5b1ccb?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    features: ['Tests standardisés', 'Courbes précises', 'Rapports PDF', 'Suivi longitudinal'],
    category: 'diagnostic'
  },
  {
    id: '6',
    ...
    features: ['Grossissement 10x-50x', 'Éclairage LED polarisé', 'Photos haute résolution', 'Stockage sécurisé'],
    category: 'diagnostic'
  }
];
      ...
      <div className="equipment-container">
        ...
        >
          ...
          <p className="equipment-subtitle">
            Un environnement moderne et professionnel pour votre santé et votre bien-être
          </p>
        </motion.div>
