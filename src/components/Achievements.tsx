...
const metrics: Metric[] = [
  ...
  },
  {
    ...
    description: 'Taux de satisfaction exceptionnellement élevé de nos patients',
    icon: <Star size={24} />,
    color: 'black'
  },
  {
...
const caseStudies: CaseStudy[] = [
  {
    ...
    description: 'Accompagnement personnalisé d\'un patient diabétique avec stabilisation glycémique.',
  ...
  },
  {
    ...
    category: 'Nutrition',
    description: 'Plan nutritionnel adapté avec suivi régulier pour une perte de poids durable.',
  ...
  },
  {
    ...
    description: 'Traitement et suivi personnalisé pour normaliser la tension artérielle.',
      ...
      <div className="achievements-container">
        ...
        >
          <h2 className="achievements-title">
            Nos Réalisations & Succès
          </h2>
          <p className="achievements-subtitle">
            Des résultats concrets au service de votre santé et de votre bien-être
          </p>
        </motion.div>
        ...
        >
          <h3 className="case-studies-title">
            Cas de Réussite
          </h3>
        ...
        >
          <div className="cta-content">
            ...
            <p className="cta-description">
              Rejoignez les milliers de patients qui nous font confiance pour leur suivi médical. 
              Ensemble, construisons votre parcours de santé.
            </p>
